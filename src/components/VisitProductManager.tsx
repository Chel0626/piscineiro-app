...
export function VisitProductManager({ 
  ...
  const handleSendWhatsApp = async () => {
    ...
    try {
      // Converter para array de strings simples para salvar
      const productsList = productsRequested.map(p => `${p.productName} (${p.quantity} unidades)`);
      ...
      const productsListText = productsRequested
      ...
      toast.success('Solicitação enviada e salva no histórico!');
